    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { 
            id: 'b1', 
            label: 'İşveren haklı sebep olmadan işten çıkardı', 
            riskDelta: -15, 
          ...
          { 
            id: 'b2', 
            label: 'İstifa ettim (kendi isteğimle)', 
            riskDelta: +18, 
      ...
      },
      {
        ...
        weight: 2.0,
        isCritical: true,
        helpText: 'Deliller dava sonucunu doğrudan etkiler. Birden fazla seçebilirsiniz.',
        options: [
          { 
            id: 'c1', 
    ...
    recommendations: {
      ...
      high: {
        ...
        actions: [
          ...
          'Ücret Garanti Fonu başvurusunu değerlendirin'
        ],
        color: '#f97316',
        icon: 'AlertTriangle',
        lawyerRecommended: true
      ...
      critical: {
        ...
        actions: [
          '🚨 ACİL: Bugün bir avukatla görüşün',
